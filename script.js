...
function getSummaryItemHtml(item, color) {
    ...
    // return `<p style="color: ${color};" class="summary-question">${item.question}${imageHtml}<br><br>Prawidłowa odpowiedź: ${item.correctAnswer}<br>Twoja odpowiedź: ${item.answer}</p>`;
